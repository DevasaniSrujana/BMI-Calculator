  ...
  return (
    <>
      <div className="container bg-gradient-to-r from-pink-500 to-purple-950 min-w-[100vw] min-h-[100vh] box-border font-sans">
        <div className="bmi-container lg:w-[30vw] min-h-[85vh] m-auto border-[5px] bg-gray-950 border-white relative top-10 rounded-2xl text-white ">
          {!showResult ? (
            <>
              ...
              <div className="gender flex text-white font-extrabold lg:w-[25vw] lg:m-auto justify-around">
                <div
                  onClick={handleMale}
                  className={`male border-1 border-gray-800 p-4 bg-gray-800 rounded-xl m-5 w-[125px] cursor-pointer ${selectedGender === "Male" ? "font-extrabold border-4 border-amber-400 bg-gray-700" : "font-bold"}`}
                >
                ...
                <div
                  ...
                  className={`female border-1 border-gray-800 p-4 bg-gray-800 rounded-xl m-5 w-[125px] cursor-pointer ${selectedGender === "Female" ? "font-extrabold border-4 border-amber-400 bg-gray-700" : "font-bold"}`}
                >
            ...
            <div className="m-2 text-center font-mono">
              <div className="text-4xl text-amber-500">YOUR RESULTS</div>
              <div className="text-3xl p-2 mt-10">Your BMI is: <strong>{bmiValue}</strong></div>
              <div className="text-3xl p-2">You are <strong>{bmiCategory}</strong></div>
              <button 
                onClick={handleBack}
                className="text-2xl font-extrabold bg-blue-800 w-[250px] border-2 border-white rounded-2xl p-2 mt-10"
              >
                BACK
              </button>
            </div>
